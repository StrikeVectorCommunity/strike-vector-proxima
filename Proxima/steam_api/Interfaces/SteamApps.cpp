...
namespace Steam
{
	...
	bool Apps::GetCurrentBetaName(char* pchName, int cchNameBufferSize) { return "public"; }
	...
	unsigned int Apps::GetInstalledDepots(DepotId_t* pvecDepots, unsigned int cMaxDepots) { return cMaxDepots; }
